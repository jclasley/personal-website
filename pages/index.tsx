	...
	return (
		<div className={styles.container}>
			<Head>
				...
				<meta
					name="description"
					content="click clack, computer go brrr"
				/>
			...
			<main className={styles.main}>
				<div className={styles.body}>
					...
					<p>
						i&apos;m jon. a software engineer, musician, and
						climbing enthusiast.
						<br />
						...
						, specifically the
						<a
							href="https://www.diabetescare.abbott"
							target="_blank"
							rel="noreferrer"
						>
							{" "}
						...
						observability, emacs, and mentorship.
						<br />
					</p>
					{/* TODO: add powered by */}
					<p>
					...
					<p>
						check out my{" "}
						<a
							href="https://github.com/jclasley"
							target="_blank"
							rel="noreferrer"
						>
							github
					...
					<p>
						find me on{" "}
						<a
							href="https://linkedin.com/in/jonlasley"
							target="_blank"
							rel="noreferrer"
						>
							linkedin
